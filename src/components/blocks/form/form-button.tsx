  ...
  return (
    <div className="w-full">
      <button
        ...
        className={`w-full inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-primary ${VARIANT_CLASSES[action.variant]} ${SIZE_CLASSES[action.size]} ${action.disabled ? "opacity-50 cursor-not-allowed" : ""}`}
      >
